defmodule SurveyLiveWeb.UserAuth do
  @moduledoc """
  Plugs and functions regarding user authentication
  """
  use SurveyLiveWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_survey_live_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SurveyLiveWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule SurveyLiveWeb.PageLive do
        use SurveyLiveWeb, :live_view

        on_mount {SurveyLiveWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SurveyLiveWeb.UserAuth, :ensure_authenticated}] do
  ...
  defp ensure_user_confirmed(conn) do
    if Application.get_env(:survey_live, :require_user_confirmation) do
