defmodule SurveyLive.UsersTest do
  use SurveyLive.DataCase

  alias SurveyLive.Users

  import SurveyLive.UsersFixtures
  alias SurveyLive.Users.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %SurveyLive.Accounts.Account{personal: true} = user.personal_account
      assert [%SurveyLive.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
