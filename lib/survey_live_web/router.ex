defmodule SurveyLiveWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {SurveyLiveWeb.Layouts, :root}
  ...
  pipeline :session_layout do
    plug :put_root_layout, {SurveyLiveWeb.Layouts, :session}
  end
  ...
  if Application.compile_env(:survey_live, :dev_routes) do
  ...
  scope "/", SurveyLiveWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SurveyLiveWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SurveyLiveWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{SurveyLiveWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", SurveyLiveWeb do
    ...
    live_session :current_user,
      on_mount: [{SurveyLiveWeb.UserAuth, :mount_current_user}] do
