defmodule SurveyLive.Accounts do
  @moduledoc """
  ...
  alias SurveyLive.Accounts.Member
  ...
  use Phoenix.VerifiedRoutes, endpoint: SurveyLiveWeb.Endpoint, router: SurveyLiveWeb.Router
  alias SurveyLive.Mailer
  alias SurveyLive.Accounts.InvitationNotifier
