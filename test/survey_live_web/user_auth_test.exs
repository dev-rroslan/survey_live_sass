defmodule SurveyLiveWeb.UserAuthTest do
  use SurveyLiveWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias SurveyLive.Users
  alias SurveyLiveWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SurveyLiveWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SurveyLiveWeb.Endpoint.subscribe(live_socket_id)
