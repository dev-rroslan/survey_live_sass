defmodule SurveyLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SurveyLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SurveyLiveWeb.Gettext, "errors", msg, opts)
    end
  end
