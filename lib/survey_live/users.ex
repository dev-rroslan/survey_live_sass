defmodule SurveyLive.Users do
  ...
  alias SurveyLive.Users.{User, UserToken, UserNotifier}
  ...
  defp create_personal_account({:ok, user} = result) do
    {:ok, account} =
      SurveyLive.Accounts.create_account(
        user, %{personal: true, name: "Personal Account"}
      )

    SurveyLive.Accounts.create_membership(account, user, %{role: :owner})
